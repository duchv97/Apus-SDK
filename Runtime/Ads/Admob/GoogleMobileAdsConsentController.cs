...
namespace Apus.GoogleMobileAds
{
    ...
    public class GoogleMobileAdsConsentController : MonoBehaviour
    {
        ...
        public bool PrivacyButtonStatus { get; private set; }
        public static event Action OnChangePrivacyButtonStatus;
        ...
        private void Start()
        {
            PrivacyButtonStatus = false;
            OnChangePrivacyButtonStatus?.Invoke();
        }
